...
| **PREDICT — trajectory (NV061)** | **TrAISformer `ct_dma`** (SOTA baseline) · isaacOnline/ships harness · **CV/CTRV/Kalman floor** (the real bar) · conformal wrapper for calibrated intervals | Brest/Ray-2019 (env-aware; **CC BY-NC-SA, research-only**) |
